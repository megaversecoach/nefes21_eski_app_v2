...
module.exports = {
    "Db": {
        "nefes21URL": `mongodb://nefes21_admin:BREath021@localhost:27017/${process.env.DB_NAME}?authSource=admin`,
        "nefes21AdminURL": `mongodb://nefes21_admin:BREath021@localhost:27017/${process.env.ADMIN_PANEL_DB_NAME}?authSource=admin`,
        "nefes21AnalyticsURL": `mongodb://nefes21_admin:BREath021@localhost:27017/${process.env.ANALYTICS_DB_NAME}?authSource=admin`
    },
    "Server": {
        "port": '2120',
        "serverIP": '78.31.65.200',
    },
    "Jwt" : {
