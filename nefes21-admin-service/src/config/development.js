...
module.exports = {
    "Db": {
        "nefes21URL": `mongodb://nefes21:8q9WAmS9CMwk@localhost:27017/${process.env.DB_NAME}?authSource=admin`,
        "nefes21AdminURL": `mongodb://nefes21:8q9WAmS9CMwk@localhost:27017/${process.env.ADMIN_PANEL_DB_NAME}?authSource=admin`,
        "nefes21AnalyticsURL": `mongodb://nefes21:8q9WAmS9CMwk@localhost:27017/${process.env.ANALYTICS_DB_NAME}?authSource=admin`
    },
    "Server": {
        "port": 2120,
        "serverIP": '167.86.70.146',
    },
    "Jwt" : {
