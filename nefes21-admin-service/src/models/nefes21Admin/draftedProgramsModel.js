...
const draftedProgramSchema = new mongoose.Schema({
    program_id : {
        type : String,
        required : true,
        unique : true
...
const DraftedProgram = Nefes21Admin.model('drafted_programs', draftedProgramSchema);

module.exports = DraftedProgram;